...
- **Reglas de Trabajo:** 
    ...
    - **CAMBIOS INCREMENTALES:** Todo cambio debe ser verificado antes del push. La información anterior no puede desaparecer; la base de datos visual siempre debe crecer o mantenerse (información >= anterior).
- **Notas:** Se casa pronto con Katty (Phone: +56982526104). Luciano es el wedding planner oficial. 

## Context
El usuario prefiere un trato cercano y divertido.
